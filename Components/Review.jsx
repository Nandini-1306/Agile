...
function ReviewForm() {
  ...
  return (
    ...
    <div
      ...
      style={{ backgroundColor: "#1D232A", borderColor: "#28a745", boxShadow: "0 8px 16px rgba(0, 0, 0, 0.6)" }}
    >
      <h2 className="text-2xl font-semibold mb-6 text-center text-white">Leave a Review</h2>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            style={{ backgroundColor: "white", color: "black", borderColor: "#28a745" }}
        ...
        {/* Review Field */}
        <div>
          <label className="block mb-2 text-sm font-medium text-white">Review</label>
          <textarea
            name="review"
