    ...
    <div className="container mx-auto my-10">
      ...
      {reviews.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {reviews.map((review) => (
            <div key={review._id} className="bg-gray-800 rounded-lg p-6 shadow-lg border border-green-500">
              <h3 className="text-xl font-bold mb-2 text-white">{review.userName}</h3>
              <p className="text-sm text-gray-300 mb-4">Email: {review.userEmail}</p>
